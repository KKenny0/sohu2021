...
#test
python train.py --do_eval --do_infer --saving_path output/RoBERTa --bert_model models/RoBERTa
#python train.py --do_eval --do_infer --saving_path output/WoBERT --bert_model models/WoBERT
#python train.py --do_eval --do_infer --saving_path output/WWM --bert_model models/WWM